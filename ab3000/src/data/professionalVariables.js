...
export const skillData = [
  ...
  },
  {
    ...
    skills: [
      ...
      ["Angular", "images/skill_icons/web_dev/angular.svg"],
      ["GraphQL", "images/skill_icons/web_dev/graphql.svg"],
...
export const timelineData = [
        {
            text: [
            "Independently designed and programmed the ML architecture (LLM models) in an upcoming product to visualize financial data.",
            "Generated data to finetune our existing models for better performance.",
            ],
            date: "September 2023 - Present",
            title: "Rose AI",
            position: "Machine Learning Engineer",
            location: "New York, NY (Remote from CA)",
            icon: faBriefcase,
            iconOffset: "left-2.5",
            iconColor: "rgb(250, 255, 205)",
            boxColor: "#ff8787",
    ...
    {
        text: [
          "Created and tested ML deployment pipeline architectures in AWS Lambda for sentence summarization and classification (NLP).",
          "Researched and implemented the best-fitting architecture and tools for linting and unit-testing the codebase (python, terraform).", 
          "Created unit tests from scratch for lambdas with pytest.",
          "Refactored, modularized, and documented existing machine learning & backend lambda functions for readability and architectural improvement.",
          "reated bash scripts for testing and configuration for ease-of-use when onboarding new engineers.",
        ],
        date: "August 2023 - September 2023",
        title: "Abstractive Health",
        position: "Founding NLP / Backend Engineer (TMP)",
  ...
  },
  {
    ...
    title: "Cisco",
    position: "Software Engineer (TMP)",
  ...
  },
  {
    ...
    title: "Honeywell",
    position: "Software Engineer I (TMP)",
