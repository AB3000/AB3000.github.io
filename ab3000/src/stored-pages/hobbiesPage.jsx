...
const slideImages = [
  "../assets/images/Web-Files/Bracelets/FullSizeRender 2.png",
  "../assets/images/Web-Files/Bracelets/FullSizeRender 3.png",
  "../assets/images/Web-Files/Bracelets/FullSizeRender 4.png",
];
...
//           if (data.match(/[^/]+(jpg|png|gif|jpeg|JPG)$/)) {
//             // console.log("sex");
//             return <img src={data} key={idx} alt=""></img>;
//           } else
//             return (
